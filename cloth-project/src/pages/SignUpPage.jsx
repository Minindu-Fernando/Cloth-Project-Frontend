    ...
    <MDBContainer fluid className='d-flex align-items-center justify-content-center bg-image' style={{backgroundImage: 'url(https://mdbcdn.b-cdn.net/img/Photos/new-templates/search-box/img4.webp)'}}>
      ...
      <MDBCard className='m-5' style={{width: '600px'}}>
        <MDBCardBody className='px-5'>
          ...
          <MDBInput label='Your Address' size='lg' type='text' value={address} onChange={(e) => setAddress(e.target.value)} wrapperClass='mb-4' />
          <MDBInput label='Contact number' size='lg' type='text' value={contactNumber} onChange={handleContactChange} wrapperClass='mb-4' />
          {contactError && <p className="text-danger">{contactError}</p>}
          <MDBInput label='Your City' size='lg' type='text' value={city} onChange={(e) => setCity(e.target.value)} wrapperClass='mb-4' />
          <MDBInput label='Your Postal Code' size='lg' type='text' value={postalCode} onChange={(e) => setPostalCode(e.target.value)} wrapperClass='mb-4' />
